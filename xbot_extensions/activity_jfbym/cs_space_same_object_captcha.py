...
def handle_captcha(web_page:xbot.web.WebBrowser, background_ele, confirm_ele , retry_count: int=5, token=""):
...
def main(args):
    ...
    # background_ele = "cs_space_same_object_background_ele"
    # confirm_ele = "cs_space_same_object_confirm_ele"
    # token = "8Z23Nm44LCjMKhP18xJNMfHK5lA6TLz4-B3fdA4T1W8"

    handle_captcha(web_page,background_ele, confirm_ele , retry_count, token)
