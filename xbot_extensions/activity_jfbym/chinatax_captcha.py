...
def handle_captcha(web_page, ele, extra, token) -> str:
    """处理验证码"""
    ...
    background_boundary_list = get_boundary_value(web_page, ele)#得到背景图的boundary,锚点
    try:
...
def main(args):
    ...
    # captcha_type = "10110"
    data = handle_captcha(web_page, ele, extra, token)
