...
def main(args):
    try:
        ...
        try:
            # 获取对应店铺账号密码
            #region 获取对应店铺账号密码
            if xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.店铺名称, operator="==", operand2="官旗", operator_options="{}", _block=("main", 6, "IF 条件")):
                账号 = "小熊电器官方旗舰店:小熊软糖"
                密码 = "130681Jia"
                
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.店铺名称, operator="==", operand2="生旗", operator_options="{}", _block=("main", 8, "Else IF")):
                账号 = "小熊生活电器旗舰店:小熊软糖"
                密码 = "130681Jia"
                
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.店铺名称, operator="==", operand2="母旗", operator_options="{}", _block=("main", 10, "Else IF")):
                账号 = "小熊母婴旗舰店:小熊软糖"
                密码 = "130681Jia"
                
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.店铺名称, operator="==", operand2="厨旗", operator_options="{}", _block=("main", 12, "Else IF")):
                账号 = "小熊厨房电器旗舰店:小熊软糖"
                密码 = "chufang123"
            ...
            # programing.comment
            #region 发票流程
            if xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.发票流程, operator="==", operand2="发票1_点同意", operator_options="{}", _block=("main", 20, "IF 条件")):
            ...
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.发票流程, operator="==", operand2="发票2_首次上传", operator_options="{}", _block=("main", 23, "Else IF")):
                package.variables['流程名称'] = xbot_visual.programing.variable(value=lambda: 初始化配置信息.对话框信息.发票流程
                , _block=("main", 24, "设置变量"))
            ...
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.发票流程, operator="==", operand2="发票3_点冲红", operator_options="{}", _block=("main", 26, "Else IF")):
                package.variables['流程名称'] = xbot_visual.programing.variable(value=lambda: 初始化配置信息.对话框信息.发票流程
                , _block=("main", 27, "设置变量"))
            ...
            elif xbot_visual.workflow.test(operand1=lambda: 初始化配置信息.对话框信息.发票流程, operator="==", operand2="发票4_重新上传", operator_options="{}", _block=("main", 29, "Else IF")):
                package.variables['流程名称'] = xbot_visual.programing.variable(value=lambda: 初始化配置信息.对话框信息.发票流程
                , _block=("main", 30, "设置变量"))
